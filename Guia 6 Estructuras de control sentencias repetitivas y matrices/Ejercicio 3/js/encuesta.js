...
with(document){
    write("<h1>Encuesta para determinar cuántas personas están a favor de la portabilidad númerica de teléfonos celulares</h1><hr>");
    write("<b>Digite \"1\" si esta a favor</b><br>");
    write("<b>Digite \"2\" si esta en contra</b><br>");
    write("<b>Digite \"3\" si se abstiene de votar</b><hr>");
}
/*Ciclo Repetitivo infinito donde se captura voto por voto
en tanto no se de por terminada el ingreso de respuestas de la encuesta*/
while (opcion==true) {
